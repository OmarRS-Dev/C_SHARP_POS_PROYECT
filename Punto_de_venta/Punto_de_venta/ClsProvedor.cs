...
namespace Punto_de_venta
{
    ...
    class ClsProveedor : ClsPersona
    {
        ...
        public override bool guardar()
        {
            ...
            cmd.Connection = cn;
            cmd.CommandText = "Insert into PROVEEDORES values (null,@rf,@no,@di,@te,@em)";
        ...
        public override bool eliminar(int cod)
        {
            ...
            MySqlCommand cmd = new MySqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "Delete from PROVEEDORES where codigo=@co";
        ...
        public override bool modificar()
        {
            ...
            MySqlCommand cmd = new MySqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = "Update PROVEEDORES set rfc=@rf, nombre=@no, direccion=@di, telefono=@te, email=@em where codigo=@co";
        ...
        public override DataTable consultar(int cod)
        {
            try
            {
                ...
                using (cn)
                {
                    MySqlCommand cmd = new MySqlCommand("Select * from PROVEEDORES where codigo =" + cod, cn);
                    MySqlDataAdapter adaptador = new MySqlDataAdapter(cmd);
